...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-east-1.hvm-ebs" = "ami-06dc98082bc55c1fc"
    "latest.ap-northeast-1.hvm-ebs" = "ami-027836fddb5c56012"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0edacd41dc7700c39"
    "latest.ap-south-1.hvm-ebs" = "ami-0b279b5bb55288059"
    "latest.ap-southeast-1.hvm-ebs" = "ami-04f570c70ff9b665e"
    "latest.ap-southeast-2.hvm-ebs" = "ami-02a3d1df595df5ef6"
    "latest.ca-central-1.hvm-ebs" = "ami-065c13e1d52d60b33"
    "latest.eu-central-1.hvm-ebs" = "ami-0857d5d1309ab8b77"
    "latest.eu-north-1.hvm-ebs" = "ami-05403e3ae53d3716f"
    "latest.eu-west-1.hvm-ebs" = "ami-048dbc738074a3083"
    "latest.eu-west-2.hvm-ebs" = "ami-0234cf81fec68315d"
    "latest.eu-west-3.hvm-ebs" = "ami-020e459baf709107d"
    "latest.sa-east-1.hvm-ebs" = "ami-04737dd49b98936c6"
    "latest.us-east-1.hvm-ebs" = "ami-0d3002ba40b5b9897"
    "latest.us-east-2.hvm-ebs" = "ami-069a0ca1bde6dea52"
    "latest.us-west-1.hvm-ebs" = "ami-0b415460a84bcf9bc"
    "latest.us-west-2.hvm-ebs" = "ami-093cba49754abd7f8"
  }
